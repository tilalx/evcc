...
func NewMockFeatureDescriber(ctrl *gomock.Controller) *MockFeatureDescriber {
	mock := &MockFeatureDescriber{ctrl: ctrl}
	mock.recorder = &MockFeatureDescriberMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockFeatureDescriber) EXPECT() *MockFeatureDescriberMockRecorder {
	return m.recorder
}
...
func (mr *MockFeatureDescriberMockRecorder) Features() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Features", reflect.TypeOf((*MockFeatureDescriber)(nil).Features))
}
...
// MockMeterReturnEnergy is a mock of MeterReturnEnergy interface.
type MockMeterReturnEnergy struct {
	ctrl     *gomock.Controller
	recorder *MockMeterReturnEnergyMockRecorder
	isgomock struct{}
}

// MockMeterReturnEnergyMockRecorder is the mock recorder for MockMeterReturnEnergy.
type MockMeterReturnEnergyMockRecorder struct {
	mock *MockMeterReturnEnergy
}

// NewMockMeterReturnEnergy creates a new mock instance.
func NewMockMeterReturnEnergy(ctrl *gomock.Controller) *MockMeterReturnEnergy {
	mock := &MockMeterReturnEnergy{ctrl: ctrl}
	mock.recorder = &MockMeterReturnEnergyMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockMeterReturnEnergy) EXPECT() *MockMeterReturnEnergyMockRecorder {
	return m.recorder
}

// ReturnEnergy mocks base method.
func (m *MockMeterReturnEnergy) ReturnEnergy() (float64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReturnEnergy")
	ret0, _ := ret[0].(float64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ReturnEnergy indicates an expected call of ReturnEnergy.
func (mr *MockMeterReturnEnergyMockRecorder) ReturnEnergy() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReturnEnergy", reflect.TypeOf((*MockMeterReturnEnergy)(nil).ReturnEnergy))
}
...
// MockBatteryChargePowerLimiter is a mock of BatteryChargePowerLimiter interface.
type MockBatteryChargePowerLimiter struct {
	ctrl     *gomock.Controller
	recorder *MockBatteryChargePowerLimiterMockRecorder
	isgomock struct{}
}

// MockBatteryChargePowerLimiterMockRecorder is the mock recorder for MockBatteryChargePowerLimiter.
type MockBatteryChargePowerLimiterMockRecorder struct {
	mock *MockBatteryChargePowerLimiter
}

// NewMockBatteryChargePowerLimiter creates a new mock instance.
func NewMockBatteryChargePowerLimiter(ctrl *gomock.Controller) *MockBatteryChargePowerLimiter {
	mock := &MockBatteryChargePowerLimiter{ctrl: ctrl}
	mock.recorder = &MockBatteryChargePowerLimiterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockBatteryChargePowerLimiter) EXPECT() *MockBatteryChargePowerLimiterMockRecorder {
	return m.recorder
}

// SetBatteryChargePowerLimit mocks base method.
func (m *MockBatteryChargePowerLimiter) SetBatteryChargePowerLimit(power *float64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetBatteryChargePowerLimit", power)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetBatteryChargePowerLimit indicates an expected call of SetBatteryChargePowerLimit.
func (mr *MockBatteryChargePowerLimiterMockRecorder) SetBatteryChargePowerLimit(power any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetBatteryChargePowerLimit", reflect.TypeOf((*MockBatteryChargePowerLimiter)(nil).SetBatteryChargePowerLimit), power)
}
...
func NewMockBatterySocLimiter(ctrl *gomock.Controller) *MockBatterySocLimiter {
	mock := &MockBatterySocLimiter{ctrl: ctrl}
	mock.recorder = &MockBatterySocLimiterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockBatterySocLimiter) EXPECT() *MockBatterySocLimiterMockRecorder {
	return m.recorder
}
...
func (m *MockBatterySocLimiter) GetSocLimits() (float64, float64) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetSocLimits")
	ret0, _ := ret[0].(float64)
	ret1, _ := ret[1].(float64)
	return ret0, ret1
}
...
func (mr *MockBatterySocLimiterMockRecorder) GetSocLimits() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSocLimits", reflect.TypeOf((*MockBatterySocLimiter)(nil).GetSocLimits))
}
...
func NewMockDimmer(ctrl *gomock.Controller) *MockDimmer {
	mock := &MockDimmer{ctrl: ctrl}
	mock.recorder = &MockDimmerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockDimmer) EXPECT() *MockDimmerMockRecorder {
	return m.recorder
}
...
func (m *MockDimmer) Dimmed() (bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDimmerMockRecorder) Dimmed() *gomock.Call {
	mr.mock.ctrl.T.Helper()
